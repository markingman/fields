...
final class FieldsDateTest extends TestCase
{
	...
	{
		$this->assertEquals([200, ['date' => '1980-01-01']], $this->client->request('date', ['date' => '1980-01-01']));
		$this->assertEquals([200, ['date' => '1990-01-01']], $this->client->request('date', ['d' => '1990-01-01']));
