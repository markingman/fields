...
final class FieldSelectMultipleMeldTest extends TestCase
{
	public function testCreate(): void
	{
		$this->assertInstanceOf(FieldSelectMultipleMeld::class, new FieldSelectMultipleMeld());
	}

	public function testInvalidArgument(): void
	{
		$M = new FieldSelectMultipleMeld();
