...
final class FieldFileValidateTest extends TestCase
{
	public function testCreate(): void
	{
		$this->assertInstanceOf(FieldFileValidate::class, new FieldFileValidate());
	}

	public function testInvalidArgument(): void
	{
		$V = new FieldFileValidate();
	...
	{
		$V = new class extends FieldFileValidate {
